from fastapi import APIRouter, BackgroundTasks, UploadFile, Path, Depends, File, Form
...
def change_variant(background_tasks: BackgroundTasks,
    ...
    variant = product_service.change_variant(product_id=product_id, variant_id=variant_id,
